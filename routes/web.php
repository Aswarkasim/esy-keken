...
use App\Http\Controllers\HomeModulController;
...
Route::get('/modul', [HomeModulController::class, 'index']);
Route::get('/modul/download', [HomeModulController::class, 'download']);
